...
#include "RichTextBlockBase.generated.h"

class UDataTable;
class URichTextBlockDecoratorBase;
class URichTextBlockReplacements;

UCLASS(Abstract, Blueprintable)
class URichTextBlockBase : public UTextLayoutWidget {
    GENERATED_BODY()
public:
protected:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    URichTextBlockReplacements* TokenReplacements;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<TSubclassOf<URichTextBlockDecoratorBase>> DecoratorClasses;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FTextReplacementPair> InstanceTokenReplacements;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Transient, meta=(AllowPrivateAccess=true))
    TArray<URichTextBlockDecoratorBase*> InstanceDecorators;
...
public:
    ...
    UFUNCTION(BlueprintCallable)
    URichTextBlockDecoratorBase* GetDecoratorByClass(TSubclassOf<URichTextBlockDecoratorBase> DecoratorClass);
